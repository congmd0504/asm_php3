...
@section('content')
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <a href="{{ route('client.show', $product->id) }}"
                                                ...
                                                <div class="fruite-img">
                                                    <img style="max-height: 200px ;" src="{{ $product->image }}"
                                                        class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                    style="top: 10px; left: 10px;">{{ $product->name_cate }}</div>
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        ...
                                                        <a href="#"
                                                            class="btn border border-secondary rounded-pill  text-primary"><i
                                                                class="fa fa-shopping-bag text-primary"></i> Add
                                                            to cart</a>
                                                    </div>
                                                </div>
                                            </a>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item">
                                                    ...
                                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        ...
                                                        <p>{{ $product->description }}</p>
                                                        <div class="d-flex justify-content-between flex-lg-wrap">
                                                            <p class="text-dark fs-5 fw-bold mb-0">{{ $product->price }}vnđ/kg</p>
                                                            <a href="#"
    ...
    <div class="container-fluid testimonial py-5">
        @include('client.layouts.tastimonial')
    </div>
    <!-- Tastimonial End -->
@endsection
