            ...
            <div class="d-flex m-3 me-0">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        @if (Route::has('login'))
                            <li class="nav-item ">
                                <a class="nav-link border border-success rounded text-success"
                        ...
                        @if (Route::has('register'))
                            <li class="nav-item ms-2">
                                <a class="nav-link border border-warning rounded text-warning"
                    ...
                    @else
                        <li class="nav-item dropdown ">
                            <a id="navbarDropdown"
                                class="nav-link dropdown-toggle border border-success rounded text-success" href="#"
